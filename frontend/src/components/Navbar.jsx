...
const Navbar = ({ isLoggedIn }) => {
  ...
  return (
    <nav style={{ padding: "10px", backgroundColor: "transparent", color: "black" }}>
      <h2 style={{color : "white"}} className="navbar_logo">Foodie</h2>
      <div>
        {!isLoggedIn ? (
          <>
            <Link to="/login" style={{ marginRight: "10px", color: "" }}>Login</Link>
